...
export const READ_SESSION_TRACE_DEFINITION: ToolDefinition = {
  get base() {
    return DEFAULT_LEGACY_SET.read_session_trace;
  },
  overrides: (modelId) => getToolSet(modelId).read_session_trace,
};
